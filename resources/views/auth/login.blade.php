        ...
        <form method="POST" action="{{ route('login') }}">
            ...
            <div class="block mt-4 text-right">
                <label for="remember_me" class="inline-flex items-center">
                    ...
                    <input id="remember_me" type="checkbox" class="rounded border-gray-300  ml-1 text-indigo-600 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" name="remember">
                </label>
            </div>
